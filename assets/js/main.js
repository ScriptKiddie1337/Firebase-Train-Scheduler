  ...
  let tRemainder = moment().diff(moment.unix(data.firstTrain), "minutes") % frequency;
  console.log(tRemainder);
  console.log(data.firstTrainUnix);
  ...
  $("#trainTable > tbody").append("<tr><td>" + trainName + "</td><td>" + destination + "</td><td>" + frequency + "</td><td>" + nextArrival + "</td><td>" + parseInt(minutesAway) + "</td></tr>");
